...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String name){
        ...
        qno = new JLabel();
        qno.setBounds(80, 280, 30, 30);
        qno.setFont(new Font("Tahoma", Font.PLAIN, 16));
        add(qno);
        
        question = new JLabel();
        question.setBounds(130, 280, 700, 30);
        ...
        lifeline.setBounds(950, 450, 170, 35);
        ...
        submit.setBounds(950, 520, 170, 35);
    ...
    public void paint(Graphics g){
        ...
        if(timer > 0){
            g.drawString(time, 930, 340);
        }else{
            g.drawString("Times up!!", 930, 340);
        }
